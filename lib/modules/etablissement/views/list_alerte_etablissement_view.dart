...
class ListAlertEtablissementView extends StatelessWidget {
  @override
                          ...
                          children: [
                            ...
                            dController.searchController.text.length != 0
                                    ...
                                    : Container(
                                        ...
                                        child: SingleChildScrollView(
                                          ...
                                          itemCount: dController
                                              .listSearchAlert.length,
                                          itemBuilder: (_ctx, index) {
                                            return AppAlertEtablissementComponent(
                                                alerte: dController
                                ...
                                : Container(
                                    ...
                                    shrinkWrap: true,
                                    itemCount: dController.listAlert.length,
                                    itemBuilder: (_ctx, index) {
                                      return AppAlertEtablissementComponent(
                                          alerte: dController.listAlert[index]);
                                    },
                                  ))),
                          ],
                        ),
