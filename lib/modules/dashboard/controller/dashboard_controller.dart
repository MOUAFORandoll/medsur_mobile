...
class DashBoardController extends GetxController {
  ...
  var listPermission = Get.find<AuthController>().listPermission;

  isPermission(permission) {
    return listPermission.contains(permission);
  }
  
  var roleUser = new Role(name: '');
  ...
  getUserRole_BD() async {
    ...
    //print(
        // '+.-----------------++++}============================================ ');
    //print(role);
    roleUser = Role.fromJson(role);

    update();
  }

  isRole(role) {
    return role == roleUser.name;
  }
}
